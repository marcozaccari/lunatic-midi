...
# C Compiler Flags
CFLAGS=-mpush-args -mno-accumulate-outgoing-args -mno-stack-arg-probe -pthread -Wno-unused-function
...
${OBJECTDIR}/lib/exceptions.o: lib/exceptions.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/exceptions.o lib/exceptions.c

${OBJECTDIR}/lib/gpio.o: lib/gpio.c
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/gpio.o lib/gpio.c

${OBJECTDIR}/lib/i2c.o: lib/i2c.c
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/i2c.o lib/i2c.c

${OBJECTDIR}/lib/ipc.o: lib/ipc.cpp
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/ipc.o lib/ipc.cpp
...
${OBJECTDIR}/lib/utils.o: lib/utils.c
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/utils.o lib/utils.c

${OBJECTDIR}/lib/zini.o: lib/zini.cpp
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/zini.o lib/zini.cpp

${OBJECTDIR}/src/adc.o: src/adc.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/adc.o src/adc.c

${OBJECTDIR}/src/buttons.o: src/buttons.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/buttons.o src/buttons.c
...
${OBJECTDIR}/src/led_monitor.o: src/led_monitor.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/led_monitor.o src/led_monitor.c
...
${OBJECTDIR}/src/main.settings.o: src/main.settings.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main.settings.o src/main.settings.c
