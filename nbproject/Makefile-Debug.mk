...
${OBJECTDIR}/lib/midi.o: lib/midi.c
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/midi.o lib/midi.c
...
${OBJECTDIR}/src/threads.devices.o: src/threads.devices.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/threads.devices.o src/threads.devices.c

${OBJECTDIR}/src/threads.midi.o: src/threads.midi.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/threads.midi.o src/threads.midi.c
